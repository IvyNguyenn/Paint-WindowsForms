...
namespace WindowsFormsApplication1
{
    class DuongCong : HinhVe
    {
        ...
        public DuongCong(Pen curPen, Point diembatdau, Point diemketthuc, Point diemmousedown,
        ...
        public override void Ve(Graphics g)
        {
            ...
            int dx = (diemKetThuc.X - diemBatDau.X) / 3;
            g.DrawBezier(drawpen, diemBatDau,
                new Point(diemBatDau.X + dx, diemKetThuc.Y - dx - dx/2),
                new Point(diemKetThuc.X - dx, diemBatDau.Y + dx + dx/2),
                diemKetThuc);
