...
{
    [Serializable()]
    class FillHinhChuNhat : HinhVe
    {
        #region Constructor 
        public FillHinhChuNhat()
            : base()
        {
        ...
        public FillHinhChuNhat(Pen curPen)
            : base(curPen)
        {
            diemBatDau.X = 0; diemBatDau.Y = 0;
            diemKetThuc.X = 0; diemKetThuc.Y = 1;
        ...
        public FillHinhChuNhat(Pen curPen, Point diembatdau, Point diemketthuc, Point diemmousedown,
        ...
        public override void Ve(Graphics g)
        {
            ...
            g.FillRectangle(brush, VeHCN(diemBatDau, diemKetThuc));
            brush.Dispose();
        }
        ...
        public override void Mouse_Down(MouseEventArgs e)
        {
            ...
            if (viTriChuotSoVoiHinhVe == 0)    //đánh dấu băt đầu di chuyển
            {
                ...
                // System.Console.WriteLine("==0, vi tri la mouse down la: " + diemConTroLucMouseDown.ToString());
            }
            else //vẽ hình mới
            {
        ...
        #region Tuần tự hóa 
        public FillHinhChuNhat(SerializationInfo info, StreamingContext ctxt)
            : base(info, ctxt)
